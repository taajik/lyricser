...
if __name__ == "__main__":
    ...
    realpath = os.path.realpath(__file__).replace('\\', '/')  ##TODO: its not so efficient, mabye os.getcwd() was good enough
    ...
    ## generating a text file containing all of the lyrics
        ...
        lyrics_path = format_path( input("Where to save all lyrics files: ") )
        print()
